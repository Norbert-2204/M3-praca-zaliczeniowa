export const countries = [
  ...
  { name: "Åland Islands", code: "AX", capital: "Mariehamn" },
  ...
  { name: "Antarctica", code: "AQ", capital: "" },
  ...
  { name: "Faroe Islands", code: "FO", capital: "Tórshavn" },
  ...
  { name: "French Southern Territories", code: "TF", capital: "" },
  ...
  { name: "Guam", code: "GU", capital: "Hagåtña" },
  ...
  { name: "Libyan Arab Jamahiriya", code: "LY", capital: "Tripoli" },
  ...
  { name: "Moldova, Republic of", code: "MD", capital: "Chișinău" },
  ...
  { name: "New Caledonia", code: "NC", capital: "Nouméa" },
  ...
  { name: "Palestinian Territory, Occupied", code: "PS", capital: "Ramallah" },
  ...
  { name: "Tonga", code: "TO", capital: "Nukuʻalofa" },
  ...
  { name: "Western Sahara", code: "EH", capital: "El Aaiún" },
